      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 w-full">
        <div className="text-center mb-6">
          ...
          <div className="relative">
            ...
            {showDropdown && (
              <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 border border-white/20 rounded-xl overflow-hidden shadow-lg z-20">
                <button
                  onClick={() => {
                    onStartGame();
                    setShowDropdown(false);
                ...
                >
                  <span>👥</span>
                  <div>
                    <div className="text-sm font-medium">Humano vs Humano</div>
                    <div className="text-xs text-purple-300">Juega con un amigo</div>
                  </div>
                </button>
              </div>
            )}
